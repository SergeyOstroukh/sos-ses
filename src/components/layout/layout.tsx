...
import { useGetAuthMeQuery, useLogOutMutation } from '@/services'
      ...
      <header className={s.appWrapper__header}>
        <div className={s.appWrapper__headerContent}>
          <img
            ...
            src={
              'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRykDv6Mr1Pd7dSjVOVPUCb2ba6d2L0r5X47A&usqp=CAU'
            }
          />
